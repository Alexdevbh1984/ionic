...
.factory('sharedFilterService', [function(){
    ...
    obj.str = "https://cors-anywhere.herokuapp.com/http://pro1.6te.net/food_menu.php?till=";
	obj.sort = "";
	obj.search = "";
	obj.category = "";
	obj.till=0;
	...
	obj.getUrl=function(){
		...
		obj.till=obj.till + 5;
		obj.str="https://cors-anywhere.herokuapp.com/http://pro1.6te.net/food_menu.php?till="+obj.till; // pass the value to url
