...
.controller('loginCtrl', function($scope,$http,$ionicPopup,$state,$ionicHistory) {
		...
		$scope.login = function() {
			str="https://cors-anywhere.herokuapp.com/http://pro1.6te.net/user-details.php?e="+$scope.user.email+"&p="+$scope.user.password;
			$http.get(str)
...
.controller('signupCtrl', function($scope,$http,$ionicPopup,$state,$ionicHistory) {
	...
	$scope.signup=function(data){
			...
			var link = 'https://cors-anywhere.herokuapp.com/http://pro1.6te.net/signup.php';
